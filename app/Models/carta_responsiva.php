...
use Exception;
class carta_responsiva extends Model
{
    use HasFactory;
    protected $table = 'carta_responsiva';
    ...
    */
    ...
    public static function requestInsertcartaR($data) {

        try{

            $response = self::insertCarta_r($data);
    ...
    */
    ...
    public static function insertCarta_r($data) {

        $arrayResponse = array();

        try{
            $id = DB::table('carta_responsiva')->insertGetId($data);
